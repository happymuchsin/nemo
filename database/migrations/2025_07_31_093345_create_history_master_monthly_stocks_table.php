...
return new class extends Migration
{
    ...
    {
        Schema::create('history_master_monthly_stocks', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('reff_id')->nullable();
            $table->foreign('reff_id')->references('id')->on('master_monthly_stocks')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('history_master_monthly_stocks');
    }
};
