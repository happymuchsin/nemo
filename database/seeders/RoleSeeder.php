...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ADMIN
        $permission = Permission::whereIn('name', ['admin-dashboard', 'admin-master', 'admin-master-division', 'admin-master-position', 'admin-master-approval', 'admin-master-area', 'admin-master-line', 'admin-master-counter', 'admin-master-box', 'admin-master-placement', 'admin-master-status', 'admin-master-needle', 'admin-master-buyer', 'admin-master-buyer', 'admin-master-category', 'admin-master-sub-category', 'admin-master-sample', 'admin-master-fabric', 'admin-master-style', 'admin-tools-user'])->get();
